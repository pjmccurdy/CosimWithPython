...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/RandNumGen-${timestamp}.log -T "RandNumGen" -geometry 140x40+30+60 -e "mvn exec:java -P ExecJava,RandNumGen" &
waitUntilJoined RandNumGen 1

cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/SimpleController-${timestamp}.log -T "SimpleController" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,SimpleController" &
waitUntilJoined SimpleController 1
