...
public class SimpleController extends SimpleControllerBase {
    ...
    private void checkReceivedSubscriptions() {
        ...
        while ((interaction = getNextInteractionNoWait()) != null) {
            if (interaction instanceof ReceiveNum) {
                handleInteractionClass((ReceiveNum) interaction);
            }
            else {
    ...
    private void execute() throws Exception {
        ...
        while (!exitCondition) {
            ...
            //
            //    SendNum vSendNum = create_SendNum();
            //    vSendNum.set_actualLogicalGenerationTime( < YOUR VALUE HERE > );
            //    vSendNum.set_dataString( < YOUR VALUE HERE > );
            //    vSendNum.set_federateFilter( < YOUR VALUE HERE > );
            //    vSendNum.set_originFed( < YOUR VALUE HERE > );
            //    vSendNum.set_sourceFed( < YOUR VALUE HERE > );
            //    vSendNum.sendInteraction(getLRC(), currentTime + getLookAhead());
            ...
            try {
                ...
                Process p = Runtime.getRuntime().exec("python ./ADDER.PY " + snum1 +separator + snum2);
...
//                }
            ...
            SendNum vSendNum = create_SendNum();
            vSendNum.set_dataString(dataString);
            log.info("Sent sendNum interaction with {}", dataString);
            
            vSendNum.sendInteraction(getLRC());
    ...
    private void handleInteractionClass(ReceiveNum interaction) {
        ///////////////////////////////////////////////////////////////
