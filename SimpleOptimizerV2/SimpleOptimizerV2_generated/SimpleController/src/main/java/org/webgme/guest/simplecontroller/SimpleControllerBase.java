...
public class SimpleControllerBase extends SynchronizedFederate {
    private SubscribedInteractionFilter _subscribedInteractionFilter =
        new SubscribedInteractionFilter();

    // constructor
    public SimpleControllerBase(FederateConfig config) throws Exception {
        super(config);
        super.createLRC();
        ...
        // interaction pubsub
        SendNum.publish(getLRC());
        ReceiveNum.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
           ReceiveNum.get_handle(),
    ...
    public SendNum create_SendNum() {
        SendNum interaction = new SendNum();
