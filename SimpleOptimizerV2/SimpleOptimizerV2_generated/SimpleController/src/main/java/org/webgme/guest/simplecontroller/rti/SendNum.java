...
/**
* Implements InteractionRoot.C2WInteractionRoot.SendNum
*/
public class SendNum extends C2WInteractionRoot {

    private static final Logger logger = LogManager.getLogger();

    /**
    * Creates an instance of the SendNum interaction class with default parameter values.
    */
    public SendNum() {}
    ...
    /**
    * Returns the handle (RTI assigned) of the SendNum interaction class.
    ...
    */
    ...
    /**
    * Returns the fully-qualified (dot-delimited) name of the SendNum interaction class.
    * Note: As this is a static method, it is NOT polymorphic, and so, if called on
    ...
    */
    public static String get_class_name() {
        return "InteractionRoot.C2WInteractionRoot.SendNum";
    }

    /**
    * Returns the simple name (the last name in the dot-delimited fully-qualified
    * class name) of the SendNum interaction class.
    *
    ...
    */
    ...
    static {
        _classNameSet.add("InteractionRoot.C2WInteractionRoot.SendNum");
        _classNameClassMap.put("InteractionRoot.C2WInteractionRoot.SendNum", SendNum.class);

        _datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendNum", _datamemberNames);
        _allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.SendNum", _allDatamemberNames);
    ...
    protected static void init(RTIambassador rti) {
        ...
        while(isNotInitialized) {
            try {
                _handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.SendNum");
        ...
        _classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum", get_handle());
        _classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.SendNum");
        _classHandleSimpleNameMap.put(get_handle(), "SendNum");
        ...
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum.actualLogicalGenerationTime", _actualLogicalGenerationTime_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum.dataString", _dataString_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum.federateFilter", _federateFilter_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum.originFed", _originFed_handle);
        _datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.SendNum.sourceFed", _sourceFed_handle);
    ...
    /**
    * Publishes the SendNum interaction class for a federate.
    *
    ...
    */
    ...
    /**
    * Unpublishes the SendNum interaction class for a federate.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Subscribes a federate to the SendNum interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    /**
    * Unsubscribes a federate from the SendNum interaction class.
    *
    * @param rti handle to the Local RTI Component
    */
    ...
    * (that is, the SendNum interaction class).
    *
    * @param handle handle to compare to the value of the handle (RTI assigned) of
    * this class (the SendNum interaction class).
    ...
    */
    ...
    protected SendNum( ReceivedInteraction datamemberMap, boolean initFlag ) {
        super( datamemberMap, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    protected SendNum( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
        super( datamemberMap, logicalTime, false );
        if ( initFlag ) setParameters( datamemberMap );
    }

    /**
    * Creates an instance of the SendNum interaction class, using
    * "datamemberMap" to initialize its parameter values.
    * "datamemberMap" is usually acquired as an argument to an RTI federate
    * callback method, such as "receiveInteraction".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendNum interaction class instance
    */
    public SendNum( ReceivedInteraction datamemberMap ) {
        this( datamemberMap, true );
    }

    /**
    * Like {@link #SendNum( ReceivedInteraction datamemberMap )}, except this
    * new SendNum interaction class instance is given a timestamp of
    * "logicalTime".
    *
    * @param datamemberMap data structure containing initial values for the
    * parameters of this new SendNum interaction class instance
    * @param logicalTime timestamp for this new SendNum interaction class
    * instance
    */
    public SendNum( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
        this( datamemberMap, logicalTime, true );
    }

    /**
    * Creates a new SendNum interaction class instance that is a duplicate
    * of the instance referred to by SendNum_var.
    *
    * @param SendNum_var SendNum interaction class instance of which
    * this newly created SendNum interaction class instance will be a
    * duplicate
    */
    public SendNum( SendNum SendNum_var ) {
        super( SendNum_var );

        set_dataString( SendNum_var.get_dataString() );
    }
    ...
    */
    ...
    public void copyFrom( Object object ) {
        ...
        if ( object instanceof SendNum ) {
            SendNum data = (SendNum)object;
